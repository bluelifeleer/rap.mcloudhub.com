const VUE = new Vue({
	...
	methods: {
		...
		rapMemberSelector: function(e, index, item) {
			// alert(index)
			this.form.membersSelected = [];
			this.form.membersList[index].selected = !this.form.membersList[index].selected;
			this.form.membersList.forEach(member => {
				if (member.selected && !(this.form.membersSelected[index])) {
					this.form.membersSelected.push(member)
				}
			})
			console.log(this.form.membersSelected[index])
			console.log(this.form.membersSelected)
		},
		rapSelectorSelectedDelete: function(e, index, value) {
			...
			this.form.membersList[index].selected = false;
			this.form.membersSelected = tmp;
		},
